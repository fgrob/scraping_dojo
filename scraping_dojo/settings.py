"""
Django settings for scraping_dojo project.
...
SECRET_KEY = 'j)y1eq!b!mkgny8q9%xtgrcofuly!@fa5!!(!p1d)vv3$v4-vx'
...
ROOT_URLCONF = 'scraping_dojo.urls'
...
WSGI_APPLICATION = 'scraping_dojo.wsgi.application'
